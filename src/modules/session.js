  ...
  var vegas = global.vegas,
    ...
    vegas.session = (function () {
      ...
      var session = {
        ...
        getDefault: function () {
            return 'testSession9'; // @todo: filesystem
        },
...
function getTestSessions () {
  var testSessions = {
    ...
    'testSession9' : {"type":"horizontal","region1":{"type":"horizontal","region1":[{"type":"EditArea","properties":{"title":"example 1"}}],"region2":{"type":"vertical","region1":{"type":"vertical","region1":[{"type":"EditArea","properties":{"title":"untitled 73"}}],"region2":[{"type":"EditArea","properties":{"title":"untitled 156"}}]},"region2":{"type":"vertical","region1":[{"type":"EditArea","properties":{"title":"untitled 14"}}],"region2":[{"type":"EditArea","properties":{"title":"untitled 342"}}]}}},"region2":[{"type":"EditArea","properties":{"title":"untitled 787"}}]}
  };
  return testSessions;
}